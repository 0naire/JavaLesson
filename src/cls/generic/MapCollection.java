...
//        HashSet<Integer> intSet = new HashSet<>();
        ...
        dictMap.put("winter", "완전 추운 겨울");  // 해당 키가 이미 존재한다면 값(VALUE)를
        dictMap.put("Autumn", "가을");
        //
        ...
        // 데이터 존재 여부 체크
        if ( dictMap.containsKey("winter"))
            dictMap.put("winter", "겨울");

        if (dictMap.containsValue("완전 추운 겨울"))
        ...
        Set<String> keySet2 = intMap.keySet();
